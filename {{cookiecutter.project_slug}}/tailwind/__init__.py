"""Python wrapper for Tailwind CSS {{ cookiecutter.tag }}."""
import logging
import sys
import typing
...
__title__ = "tailwind"
__description__ = "Python wrapper for Tailwind CSS {{ cookiecutter.tag }}."
...
_RELATIVE_TAIWIND_BIN = "bin/{{ cookiecutter.bin_basename }}"
TAILWIND_BIN = str(Path(__file__).parent.resolve().joinpath(_RELATIVE_TAIWIND_BIN))
TAILWIND_VERSION = "{{ cookiecutter.tag }}"
